namespace Package
{
	public class SALADDefinedFoldersClass
	{
		string m_rootfolder;
		...
		public SALADDefinedFoldersClass(string provided_rootfolder)
		{
		...
		public SALADDefinedFoldersClass(SALADDefinedFoldersClass provided_obj)
		{
